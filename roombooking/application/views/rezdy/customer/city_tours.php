...
//                            </div>   
            ...
            if (o.locationAddress.city.includes(city) || o.name.includes(city)) {
                if ($i % 4 == 0) {
                ...
                toAppend = toAppend + '<img src="' + o.images[0].thumbnailUrl + '" class="img-responsive" style="width:100%;height: 230px;">';
                toAppend = toAppend + '</a>';

                toAppend = toAppend + '<div class="tour-dec">';
                toAppend = toAppend + '<p> <b>$' + o.advertisedPrice + ' &nbsp </b>' + o.name;
                toAppend = toAppend + '</p>';
...
<div class="listing">
    ...
    <?php } ?>
                                    ...
                                    <div class="col-md-3">
                                        <a href="">
                                            <div class="tour-section">
                                                <a href="<?php echo site_url('user/overview/'.$row1['id']) ?>"><img src="<?php echo $row1['image_url']; ?>" class="img-responsive" style="height: 230px;"> </a>
                                                <div class="tour-dec">                    
                                                    <p><b>$ <?php echo $row1['price']; ?> </b> <?php echo $row1['name']; ?></p>
<!--                                                            <div class="fullwidth">
                                                                <div class="star-home">
