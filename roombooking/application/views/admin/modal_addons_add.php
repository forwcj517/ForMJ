            ...
            <div class="panel panel-primary" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title" >
                        ...
                        <?php echo get_phrase('add_addons'); ?>
                    </div>
                </div>
                <div class="panel-body">


                    <?php echo form_open_multipart('admin/basic_addons/create', array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => "multipart/form-data")); ?>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-5">
                            <button type="submit" class="btn btn-info" ><?php echo get_phrase('add_addons'); ?></button>
                        </div>
                    </div>
...
<script>
    ...
    function myFunction() {
        ...
        document.getElementById("pu").value = 5 / (value * multi);
    }
