...
<!--                <form action="<?php echo site_url('admin/manager_city/create');?>" class="form-horizontal form-groups-bordered validate" enctype="multipart/form-data"/>-->
    ...
    <?php echo form_open_multipart('admin/audiolist_upload_it/create/cc/'.$param2.'/category',  array('class' => 'form-horizontal form-groups-bordered validate','enctype'=>"multipart/form-data"));?>
                ...
                <div class="form-group">
                    ...
                    <div class="row" style="margin-top: 10px;">
                        ...
                        <div class="col-sm-5">
                            <textarea type = "text" class = "form-control" name="description" cols="40" rows="5"  required autofocus></textarea>
                        </div>    
                    </div>   
                    <div class="row" style="margin-top: 10px;">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('video_id'); ?></label>											
                        <div class="col-sm-5">
                            <input type = "text" class = "form-control" name="video_id" cols="40" rows="5"  required autofocus/>
                        </div>    
                    </div>  
                    <div class="row" style="margin-top: 10px;">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('price'); ?></label>											
                        <div class="col-sm-5">
                            <input type = "number" class = "form-control" name="price" cols="40" rows="5"  required autofocus/>
                        </div>    
                    </div>
                    <div class="row" style="margin-top: 10px;">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('max_count'); ?></label>											
                        <div class="col-sm-5">
                            <input type = "number" class = "form-control" name="max_count"  value="" required autofocus/>
                        </div>    
                    </div>
                    ...
                    <div class="row" style="margin-top: 10px;">
                        ...
                        <div class="col-sm-5">
                            <textarea type = "text" class = "form-control" name="include" cols="40" rows="5"  required autofocus></textarea>
                        </div>    
                    </div>
                    <div class="row" style="margin-top: 10px;">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('know'); ?></label>											
                        <div class="col-sm-5">
                            <textarea type = "text" class = "form-control" name="know" cols="40" rows="5"  required autofocus></textarea>
                        </div>    
                    </div>
                    ...
                    <div class="row" style="margin-top: 10px;">
                        ...
                        <div class="col-sm-5">
                            <textarea type = "text" class = "form-control" name="summary" cols="40" rows="5"  required autofocus></textarea>
                        </div>    
                    </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('choose logo file'); ?></label>	
                        <div class=" col-sm-5">
                            <input type="file" name="userlogo" size="20" />
                        </div>
                    </div>
                    <div class="row" style="margin-top: 10px;">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('choose video file'); ?></label>	
                        <div class=" col-sm-5">
                ...
                <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            ...
                            <select id="category_id" name="city_id" class="form-control" required data-validate="required" data-message-required="<?php echo get_phrase('value_required'); ?>" autofocus>											
                                <?php
                                $semesters = $this->db->get_where('city', array('company'=>$this->session->userdata('admin_id')))->result_array(); //array('company' => $this->session->userdata('admin_id'))
...
<?php endforeach; ?>
                ...
                <div class="form-group" hidden = "true">
                    <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('category_id'); ?></label>										
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="category_id" value=<?php echo $param2; ?> READONLY>
                    </div>
                </div>                         
                ...
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-5">
                        <button type="submit" class="btn btn-info"><?php echo get_phrase('add_tour'); ?></button>
                    </div>
                </div>
