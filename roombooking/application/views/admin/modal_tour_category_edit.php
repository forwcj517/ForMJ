...
<!--                <form action="<?php echo site_url('admin/manager_city/create');?>" class="form-horizontal form-groups-bordered validate" enctype="multipart/form-data"/>-->
    ...
    <?php echo form_open_multipart('admin/audiolist_upload_it/do_update/' . $row['id'] . '/' . $param3.'/category',  array('class' => 'form-horizontal form-groups-bordered validate','enctype'=>"multipart/form-data"));?>
