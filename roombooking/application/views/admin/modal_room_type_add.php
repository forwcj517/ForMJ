            ...
            <div class="panel panel-primary" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title" >
                        ...
                        <?php echo get_phrase('add_room_type'); ?>
                    </div>
                </div>
                <div class="panel-body">


                    <?php echo form_open_multipart('admin/manager_room_type/create', array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => "multipart/form-data")); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id = "description" name="description" value="" required autofocus >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-5">
                            <button type="submit" class="btn btn-info"><?php echo get_phrase('add_room_type'); ?></button>
                        </div>
                    </div>
