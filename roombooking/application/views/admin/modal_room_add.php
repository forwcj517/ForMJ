...
<!--                <form action="<?php echo site_url('admin/manager_city/create'); ?>" class="form-horizontal form-groups-bordered validate" enctype="multipart/form-data"/>-->
                <?php echo form_open_multipart('admin/manager_room/create', array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => "multipart/form-data")); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <textarea type="text" class="form-control" id = "description" name="description" value="" required autofocus ></textarea>
                    </div>
                </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <textarea type="text" class="form-control" id = "summary" name="summary" value="" required autofocus ></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="number" class="form-control" id = "price" name="price" value="" required autofocus >
                    </div>
                </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="number" class="form-control" id = "no_of_bed" name="no_of_bed" value="" required autofocus >
                    </div>
                </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="number" class="form-control" id = "capacity" name="capacity" value="" required autofocus >
                    </div>
                </div>
