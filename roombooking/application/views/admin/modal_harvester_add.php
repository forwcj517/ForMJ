		...
		<div class="panel panel-primary" data-collapsed="0">
        	<div class="panel-heading">
            	<div class="panel-title" >
					...
					<?php echo get_phrase('add_harvester');?>
            	</div>
            </div>
			<div class="panel-body">
						...
						<?php echo form_open_multipart('admin/manager_provider/create' ,  array('class' => 'form-horizontal form-groups-bordered validate','enctype'=>"multipart/form-data"));?>
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" class="form-control" id = "personalNo" name="personalNo" value="" required autofocus >
											</div>
										</div>
									    ...
									    <div class="form-group">
											<div class="col-sm-offset-3 col-sm-5">
												<button type="submit" class="btn btn-info"><?php echo get_phrase('add_harvester');?></button>
											</div>
										</div>
