...
<!--                <form action="<?php echo site_url('admin/manager_city/create');?>" class="form-horizontal form-groups-bordered validate" enctype="multipart/form-data"/>-->
    ...
    <?php echo form_open_multipart('admin/audiolist_upload_it/create/cc/'.$param2,  array('class' => 'form-horizontal form-groups-bordered validate','enctype'=>"multipart/form-data"));?>
                ...
                <div class="form-group">
                    ...
                    <div class="row" style="margin-top: 10px;">
                        ...
                        <div class="col-sm-5">
                            <input type = "text" class = "form-control" name="video_id" cols="40" rows="5" />
                        </div>    
                    </div>  
                    <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="row" style="margin-top: 10px;">
                        ...
                        <div class="col-sm-5">
                            <input type = "number" class = "form-control" name="max_count"   required autofocus/>
                        </div>    
                    </div> 
                ...
                <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            ...
                            <select id="category_id" name="category_id" class="form-control" required data-validate="required" data-message-required="<?php echo get_phrase('value_required'); ?>" autofocus>											
                                <?php
                                $semesters = $this->db->get_where('category', array('company'=>$this->session->userdata('admin_id')))->result_array(); //array('company' => $this->session->userdata('admin_id'))
