        ...
        <div class="row">
            ...
            <div class="col-md-12" id="reservation">
                ...
                <div class="tile-stats tile-red">
                    <div class="icon"><i class="fa fa-group"></i></div>
                    <div class="num" data-start="0" data-end="<?php echo $this->db->count_all('reservation'); ?>" data-postfix="" data-duration="1500" data-delay="0">0</div>
            ...
            <div class="col-md-12" id="tour">
                ...
                <div class="tile-stats tile-green">
                    ...
                    <div class="num" data-start="0" data-end="<?php echo $this->db->count_all('tour'); ?>" data-postfix="" data-duration="800" data-delay="0">0</div>

                    <h3><?php echo get_phrase('Tour'); ?></h3>
